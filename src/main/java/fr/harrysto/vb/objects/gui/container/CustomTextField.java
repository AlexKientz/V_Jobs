package fr.harrysto.vb.objects.gui.container;
...
public class CustomTextField extends Gui
{
    ...
    public CustomTextField(int componentId, FontRenderer fontrendererObj, int x, int y, int par5Width, int par6Height)
    {
        this.id = componentId;
    ...
    public CustomTextField(int id, FontRenderer fontRenderer) {
        this.id = id;
    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            ...
            if (!s.isEmpty())
            {
                ...
                j1 = this.fontRenderer.drawString(s1, (int) l, (int) i1, i);
            }
            ...
            {
                j1 = this.fontRenderer.drawString(s.substring(j), (int) j1, (int) i1, i);
            }
            ...
            if (flag1)
            {
                ...
                {
                    this.fontRenderer.drawString("_", (int) k1, (int) i1, i);
                }
            }
